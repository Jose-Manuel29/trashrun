...
func game_over(mensaje, ganador):
	...
	# Ahora estas líneas ya no fallarán:
	GameManager.ultimo_ganador = ganador
	GameManager.puntos_finales_j1 = GameManager.score_p1
	GameManager.puntos_finales_j2 = GameManager.score_p2
